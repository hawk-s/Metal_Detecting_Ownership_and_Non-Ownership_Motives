...
dataframe_for_average = load_excel_to_dataframe('all_pous_archeo_rate+area_for_average_cration.xlsx')
...
#area_municipality:
dataframe_for_average_vymera_municipality = load_excel_to_dataframe('pocet_a_rozloha.xlsx')
