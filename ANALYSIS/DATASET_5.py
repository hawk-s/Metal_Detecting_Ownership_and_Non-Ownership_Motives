...
'''
df1 = load_excel_to_dataframe('ANALYSIS/additional_data/ancient_original_dfs/artefakty_doba_bronzova.xlsx')
df2 = load_excel_to_dataframe('ANALYSIS/additional_data/ancient_original_dfs/artefakty_doba_zelezna.xlsx')
df3 = load_excel_to_dataframe('ANALYSIS/additional_data/ancient_original_dfs/artefakty_doba_rimska.xlsx')
df4 = load_excel_to_dataframe('ANALYSIS/additional_data/ancient_original_dfs/artefakty_stehovani_narodu.xlsx')
df5 = load_excel_to_dataframe('ANALYSIS/additional_data/ancient_original_dfs/artefakty_slovane.xlsx')
df6 = load_excel_to_dataframe('ANALYSIS/additional_data/ancient_original_dfs/artefakty_rany_stredovek.xlsx')
df7 = load_excel_to_dataframe('ANALYSIS/additional_data/ancient_original_dfs/artefakty_stredovek.xlsx')
...
save_dataframe_to_excel(df, 'ancient_artifacts.xlsx')
'''
...
df = load_excel_to_dataframe('ANALYSIS/ancient_artifacts.xlsx')
